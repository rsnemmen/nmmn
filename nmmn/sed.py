...
:param datafile: log file generated by the semi-analytical RIAF model, containing the black hole mass, electron number density and ion temperature. e.g. 'cd ~/science/projects/adafjet/adaf/perl/run01/out_01'
...
• Zabalza 2015
	...
	# - scale height $H(R)$
	r,ti,h,ne = numpy.loadtxt(datafile,unpack=True,usecols=(0,3,7,14))
